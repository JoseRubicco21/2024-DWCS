...
function createOption(string $option, string $value){
    ...
    */
    ...
    $searchedValue = array_search($_COOKIE["subject"], $subjectsToEnrollArray); // returns a key to the needed
    ...
    <main>
        ...
        <form action="./manage.php" method="POST">
            <div>
                ...
                <input type="text" name="name" id="form-name" value="<?php echo $_COOKIE["name"]?>" required>
            </div>
